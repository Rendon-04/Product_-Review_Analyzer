...
# ✅ Define models after db.init_app()
class Review(db.Model):
    __tablename__ = 'review'  # ✅ Explicit table name
    __table_args__ = {'extend_existing': True}  # ✅ Prevent duplicate table issue
...
def analyze():
    ...
    # ✅ Run function inside app context
...
def get_themes():
    ...
    return jsonify(sorted_themes[:10])  # Return top 10 themes
